...
$PWD/../../../riscv-gnu-toolchain/drops/bin/clang -g -O0 -I$PWD/../../drops_riscv_rt/include -L$PWD/../../drops_riscv_rt/lib/static -L. main.c -lOpenCL -Wl,--whole-archive -lvecadd -Wl,--no-whole-archive -o vecadd